...
function postQuote(args){
  (args.author ? $('#author').text("- "+ args.author) : $('#author').text("- Anonymous"))
...
let animations = ['animate__fadeInDown', 'animate__fadeInUp', 'animate__fadeIn', 'animate__zoomIn', 'animate__slideInDown', 'animate__slideInUp', 'animate__zoomInDown', 'animate__zoomInLeft', 'animate__zoomInRight' ]
